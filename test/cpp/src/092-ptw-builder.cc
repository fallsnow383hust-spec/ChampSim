...
auto make_dram()
{
  return champsim::modules::ModuleBuilder{"test_dram", "DRAM", nullptr, champsim::defaults::default_memory_controller()};
}

auto make_vmem(MEMORY_CONTROLLER& dram)
{
  auto builder = champsim::modules::ModuleBuilder{"test_vmem", "VMEM", nullptr, champsim::defaults::default_vmem()};
...
TEST_CASE("The PTW's MSHR size can be specified")
{
  ...
  champsim::modules::ModuleBuilder ptw_builder{"test_ptw_92_0", "PTW", nullptr, champsim::defaults::default_ptw()};
  ptw_builder.add_parameter("mshr_size", static_cast<uint32_t>(num_mshrs));
  ptw_builder.add_parameter("vmem", static_cast<VirtualMemory*>(&vmem));
...
TEST_CASE("The PTW's tag and fill bandwidth can be specified")
{
  ...
  champsim::modules::ModuleBuilder ptw_builder{"test_ptw_92_1", "PTW", nullptr, champsim::defaults::default_ptw()};
