...
{
  bimodal uut{champsim::modules::ModuleBuilder{"t171_bimodal_0", "bimodal"}};
  ...
  REQUIRE(uut.predict_branch(ip_under_test, champsim::address{}, false, 0));
}

TEST_CASE("The bimodal predictor predicts not taken after many not-taken branches")
{
  bimodal uut{champsim::modules::ModuleBuilder{"t171_bimodal_1", "bimodal"}};
  champsim::address ip_under_test{0xdeadbeef};
  ...
  REQUIRE_FALSE(uut.predict_branch(ip_under_test, champsim::address{}, false, 0));
}

TEST_CASE("After saturating not-taken, the bimodal predictor continues to predict not taken after one taken branch")
{
  bimodal uut{champsim::modules::ModuleBuilder{"t171_bimodal_2", "bimodal"}};
  champsim::address ip_under_test{0xdeadbeef};
...
{
  bimodal uut{champsim::modules::ModuleBuilder{"t171_bimodal_3", "bimodal"}};
  champsim::address ip_under_test{0xdeadbeef};
...
{
  bimodal uut{champsim::modules::ModuleBuilder{"t171_bimodal_4", "bimodal"}};
  champsim::address ip_under_test{0xdeadbeef};
...
{
  bimodal uut{champsim::modules::ModuleBuilder{"t171_bimodal_5", "bimodal"}};
  champsim::address ip_under_test{0xdeadbeef};
