...
TEST_CASE("A cache can examine the RQ sizes of its channels")
{
  ...
  CACHE uut{champsim::modules::ModuleBuilder{"t400_cache_0", "DEFAULT_CACHE", champsim::defaults::default_l1d().add_parameter("mshr_size", static_cast<uint32_t>(8))}.add_parameter("upper_levels", std::move(queue_ptrs))};
...
TEST_CASE("A cache can examine the WQ sizes of its channels")
{
  ...
  CACHE uut{champsim::modules::ModuleBuilder{"t400_cache_1", "DEFAULT_CACHE", champsim::defaults::default_l1d().add_parameter("mshr_size", static_cast<uint32_t>(8))}.add_parameter("upper_levels", std::move(queue_ptrs))};
...
TEST_CASE("A cache can examine the PQ sizes of its channels")
{
  ...
  CACHE uut{champsim::modules::ModuleBuilder{"t400_cache_2", "DEFAULT_CACHE", champsim::defaults::default_l1d().add_parameter("mshr_size", static_cast<uint32_t>(8))}.add_parameter("upper_levels", std::move(queue_ptrs)).add_parameter("pq_size", static_cast<std::size_t>(pq_size + queue_count))};
...
SCENARIO("A cache can examine the RQ sizes of its channels")
{
  ...
  GIVEN("A cache with " + std::to_string(queue_count) + " upper levels")
  {
    ...
    CACHE uut{champsim::modules::ModuleBuilder{"t400_cache_3", "DEFAULT_CACHE", champsim::defaults::default_l1d().add_parameter("mshr_size", static_cast<uint32_t>(8))}.add_parameter("upper_levels", std::move(queue_ptrs))};
...
SCENARIO("A cache can examine the WQ sizes of its channels")
{
  ...
  GIVEN("A cache with " + std::to_string(queue_count) + " upper levels")
  {
    ...
    CACHE uut{champsim::modules::ModuleBuilder{"t400_cache_4", "DEFAULT_CACHE", champsim::defaults::default_l1d().add_parameter("mshr_size", static_cast<uint32_t>(8))}.add_parameter("upper_levels", std::move(queue_ptrs))};
...
SCENARIO("A cache can examine the PQ sizes of its channels")
{
  ...
  GIVEN("A cache with " + std::to_string(queue_count) + " upper levels")
  {
    ...
    CACHE uut{champsim::modules::ModuleBuilder{"t400_cache_5", "DEFAULT_CACHE", champsim::defaults::default_l1d().add_parameter("mshr_size", static_cast<uint32_t>(8))}.add_parameter("upper_levels", std::move(queue_ptrs))};
