...
TEST_CASE("The basic_btb module does not overflow its bounds.")
{
  ...
  O3_CPU uut{champsim::modules::ModuleBuilder{"uut_core", "DEFAULT_CORE", nullptr, champsim::defaults::default_core()}};
  O3_CPU other_cpu{champsim::modules::ModuleBuilder{"uut_core", "DEFAULT_CORE", nullptr, champsim::defaults::default_core()}};
