...
{
  champsim::channel uut{champsim::modules::ModuleBuilder{"test_channel_38_0", "DEFAULT_CHANNEL", nullptr, champsim::defaults::default_channel()}};
...
{
  champsim::channel uut{champsim::modules::ModuleBuilder{"test_channel_38_1", "DEFAULT_CHANNEL", nullptr, champsim::defaults::default_channel()}};
...
{
  champsim::channel uut{champsim::modules::ModuleBuilder{"test_channel_38_2", "DEFAULT_CHANNEL", nullptr, champsim::defaults::default_channel()}};
...
{
  champsim::channel uut{champsim::modules::ModuleBuilder{"test_channel_38_3", "DEFAULT_CHANNEL", nullptr, champsim::defaults::default_channel()}};
...
TEST_CASE("A const channel can return its RQ size")
{
  ...
  champsim::modules::ModuleBuilder channel_builder{"test_channel_38_4", "DEFAULT_CHANNEL", nullptr, champsim::defaults::default_channel()};
...
TEST_CASE("A const channel can return its WQ size")
{
  ...
  champsim::modules::ModuleBuilder channel_builder{"test_channel_38_5", "DEFAULT_CHANNEL", nullptr, champsim::defaults::default_channel()};
...
TEST_CASE("A const channel can return its PQ size")
{
  ...
  champsim::modules::ModuleBuilder channel_builder{"test_channel_38_6", "DEFAULT_CHANNEL", nullptr, champsim::defaults::default_channel()};
