...
drrip::drrip(std::string name, CACHE* cache, champsim::modules::ModuleBuilder builder) : NUM_SET(cache->NUM_SET), NUM_WAY(cache->NUM_WAY), rrpv(static_cast<std::size_t>(NUM_SET * NUM_WAY))
{
